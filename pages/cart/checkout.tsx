...
const CheckoutPage = () => {
  ...
  const [groupCounter, setGroupCounter] = useState(useSelector((state: RootState) => {
    const totalCount = state?.cart?.cartItems[0]?.count ? state.cart.cartItems[0].count : 0;
    return totalCount
  }));
        ...
        <div className="container">
            ...
            <div className="checkout__col-6">
              ...
              <div className="block">
                ...
                <form className="form">
                  ...
                  <div className="form__input-row form__input-row--two">
                    <div className="form__col">
                      <input className="form__input form__input--sm" type="text" placeholder="Age" />
                    </div>
                  ...
                  {Array.from(Array(groupCounter)).map((c, index) => {
                    return (
                      <div>
                        <h2>Group meber {groupCounter + 1}</h2>
                        <div className="form__input-row form__input-row--two">
                          <div className="form__col">
                            <input className="form__input form__input--sm" type="text" placeholder="First name" />
                          </div>
                ...
                <div className='checkout__count-buttons'>
                  <button onClick={() => {if(groupCounter < 22){setGroupCounter(groupCounter + 1)}else{null}}}>Add group member</button>
                  <button onClick={() => {if(groupCounter > 0){setGroupCounter(groupCounter - 1)}else{null}}}>Remove group member</button>
                </div>
              </div>
            </div>
          ...
          <div className="cart-actions cart-actions--checkout">
            ...
            <div className="cart-actions__items-wrapper">
              ...
              <button type="button" className="btn btn--rounded btn--yellow">Request payment</button>
            </div>
          </div>
        </div>
      </section>
