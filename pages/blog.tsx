    ...
    <div className="blog-page">
      <div className="container">
        ...
        <div  className='blogs'>
          ...
          <Link href={"/blog/2"}>
            <a className="blog-wrapper">
              <img alt={"entiquette"} src={"/images/blogs/entiquette.jpg"} />
          ...
          <Link href={"/blog/3"}>
            <a className="blog-wrapper">
              <img alt={'cloths'} src={"/images/blogs/cloths.jpg"} />
          ...
          <Link href={"/blog/6"}>
            <a className="blog-wrapper">
              <img alt={'best'} src={"/images/blogs/best.jpg"} />
          ...
          <Link href={"/blog/4"}>
            <a className="blog-wrapper">
              <img alt={'safari'} src={"/images/blogs/safari.jpg"} />
          ...
          <Link href={"/blog/8"}>
            <a className="blog-wrapper">
              <img alt={'wish'} src={"/images/blogs/wish.jpg"} />
          ...
          <Link href={"/blog/7"}>
            <a className="blog-wrapper">
              <img alt={'usefull'} src={"/images/blogs/usefull.jpg"} />
