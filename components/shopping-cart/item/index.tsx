    ...
    <tr>
      <td>
        <div className="cart-product">
          ...
          <Image placeholder="blur" blurDataURL='data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mN8tsq2HgAGmQJO71KAngAAAABJRU5ErkJggg==' layout={'fixed'} width={50} height={50}  alt={"image thumbnail"} referrerPolicy="no-referrer" src={thumb} />
          </div>
